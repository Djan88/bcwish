      ...
      <div class="box">
        ...
        <div class="row">
          ...
          <div class="col-md-7 col-md-pull-5 col-sm-12">
            ...
            <p>Подсознание управляет нашими мыслями, желаниями и поступками. Напряжения подсознания могут наследоваться, приобретать я в детстве, а затем у углубляться на протяжение всей жизни человека, делая эту жизнь порой невыносимой и создавая ощущение фатальности событий.</p>
            <p>Полностью избавиться от этих напряжений подсознания невозможно - мы так устроены природой.</p>
            <p>Но мы можем управлять своим подсознанием с помощью технологий, одной из которых и является "Девяточка".</p>
            <p>Мы может определить тип, причину появления, локализацию в телесном подсознании и закономерности влияния на нас этих напряжений. Мы можем на какое-то время уменьшить влияние напряжений подсознания на нас при однократной сессии, а при регулярном использовании "Девяточки" - практически нивелировать эти патологические схемы реагирования и получить реальное освобождение от нашего внутреннего рабства.</p>
            <p>Люди осознанные, берущие ответственность за свою жизнь и здоровье на себя, оценят "Девяточку" по достоинству.</p>
            <p>Методика противопоказано тем, кто ждёт чудесного "исцелителя - Айболита", который возьмёт на себя ответственность и разгребет завалы ваших проблем, так как подобные люди не знают - что делать с полученной свободой, так как не привыкли отвечать за свою жизнь, и потом истошно вопят: "... Верните все назад!".</p>
            <p>Мы называем" Девяточку" игрой, так как это снимает барьерное напряжение пользователей, на самом деле "Девяточка" -  есть технология для диагностики и управления напряжениями телесного подсознания человека.</p>
            <p><b>Как это работает?</b></p>
            <p>1. Нейрофизиологический феномен Р300 использован в оцифраторе напряжений подсознания. Последовательные серии ритмичного движения пальцев левой руки (правое полушария головного мозга) позволяют оцифровать и алгоритмизировать напряжения телесного подсознания по зонам DSV с учётом динамики текущего состояния клиента.</p>
            <p>2. Игровые карты (или игровые поля) представлены динамикой смещения циклической  активности зон DSV уровней 2-3-4.</p>
            <p>3. Игровые фишки представлены стандартизированными по размеру органическими носителями Флюэда напряжений телесного подсознания с нанесенными формулами удержания контента.</p>
            <p><b>Как играть?</b></p>
          ...
          <div class="box">
            ...
            <div class="row">
              ...
              <div class="col-md-5 col-md-pull-7 col-sm-12">
                <figure class="frame"><img src="<?php bloginfo('template_url'); ?>/style/images/art/chikurov.jpg" alt="" /></figure>
              </div>
              <!-- /column -->
            </div>
            <!-- /.row -->

      ...
      <div class="fullscreenbanner">
        <ul>
          <li data-transition="fade"> <img src="<?php bloginfo('template_url'); ?>/style/images/dummy.png" alt="slidebg1" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="repeat">
            <h1 class="tp-caption caption large sfb" data-x="center" data-y="center" data-voffset="-25" data-speed="900" data-start="1000" data-fontsize="['45','45','35','35']" data-endspeed="100" data-easing="Sine.easeOut">"Девяточка"</h1>

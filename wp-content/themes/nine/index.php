  ...
  <div class="container">
    ...
    <section id="contact">
      <div class="box">
        ...
        <p class="howto">Хотите узнать как получить доступ к "Девяточке" или просто возникло желание оставить отзыв? Воспользуйтесь формой ниже!<br>Тут можно задать вопрос о проекте, узнать где и когда можно поиграть или просто сказать нам спасибо!:)</p>
        <div class="divide20"></div>
        <!-- /.services-2 -->

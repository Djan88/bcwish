  ...
  <div class="container">
    ...
    <section id="contact">
      <div class="box">
        ...
        <p class="howto">Хотите узнать как получить персональный доступ к <b>"Девяточке"</b>? Воспользуйтесь формой ниже!<br>Тут можно задать вопрос о проекте, узнать где и когда можно поиграть или просто оставить отзыв!</p>
        <div class="divide20"></div>
        <!-- /.services-2 -->

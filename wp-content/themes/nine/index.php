...
<div class="body-wrapper">
  <nav class="navbar navbar-default" role="navigation">
    <div class="navbar-header"> <a class="btn responsive-menu" data-toggle="collapse" data-target=".navbar-collapse"><i></i></a>
      <div class="navbar-brand text-center"> <a href="index.html"><img src="<?php bloginfo('template_url'); ?>/style/images/logo.png" alt="" data-src="<?php bloginfo('template_url'); ?>/style/images/logo.png" data-ret="style/images/logo@2x.png" class="retina" /></a> </div>
      <!-- /.navbar-brand --> 
    </div>
    <!-- /.navbar-header -->
...
<script>
	jQuery.backstretch(["style/images/art/bg1.jpg"]);
</script>
</body>
</html>

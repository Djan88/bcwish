  ...
  <div class="container">
    ...
    <section id="contact">
      <div class="box">
        ...
        <p class="howto">Хотите узнать как получить персональный доступ к <b>"Девяточке"</b> или просто возникло желание оставить отзыв? Воспользуйтесь формой ниже!<br>Тут можно задать вопрос о проекте, узнать где и когда можно поиграть!</p>
        <div class="divide20"></div>
        <!-- /.services-2 -->

        ...
        <div class="row">
          <div class="col-md-12 steps">
            ...
            <div class="steps_item steps_item_5 wow bounceInUp" data-wow-duration="1.4s">
              ...
              <p class="description">Перенесите все зоны с шаблонного изображения на фото клиента. Начните с актуальной.За тем поместите калибровочное кольцо так чтоб клинет оказался в нем целиком</p>
            </div>
            <div class="steps_item steps_item_6 wow bounceInUp" data-wow-duration="1.4s">
              <!-- <div class="icon"></div> -->
              <h4 class="title">Выполнение протокола</h4>
              <p class="description">После переноса зон запустите выполнение протокола. Программа выполняется 25 — 35 мин. В процессе работы нежелательно выключать устройство и переходить на другие вкладки браузера</p>
            </div>
          </div>
        </div>

...
<body>
  ...
  <header id="header">
    ...
    <button type="button" class="wizard_play hidden header_btn">
      ...
      <i class="fa fa-stop-circle wizard_stop_icon hidden"></i>
    </button>
            ...
            <?php } else if (current_user_can('contributor') || current_user_can('administrator')) { ?>
              ...
              <div>
                ...
                <div class="for_desktop">
                  <svg class="steps_icon" id="Слой_2" data-name="Слой 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1233 567"><title>arrow_from_down_to_up</title><path d="M44.55,142.88c1.22-.77,2.42-1.54,3.54-2.39a33.42,33.42,0,0,0,3.17-2.75,36.55,36.55,0,0,0,5.2-6.54c1.51-2.37,2.79-4.9,4.11-7.46.65-1.28,1.32-2.56,2.06-3.82a16.17,16.17,0,0,1,2.65-3.52l.34-.32v.42h0c1.58,5.52,3.07,11,5,16.19a53.57,53.57,0,0,0,3.56,7.54,24.52,24.52,0,0,0,5.24,6.48l-.21.32a18,18,0,0,1-6.58-5.78,34.28,34.28,0,0,1-4.18-7.71A47.3,47.3,0,0,1,66,125.19a38.61,38.61,0,0,1-.79-8.64h0l.33.1a22.81,22.81,0,0,0-1.89,3.8l-1.62,4a50.58,50.58,0,0,1-3.87,7.85A27.77,27.77,0,0,1,52.43,139a21.93,21.93,0,0,1-7.73,4.2Z"/><path d="M61.51,138.92c.45,0-1-.24,1-.15a2.54,2.54,0,0,1,0,.29l0,.4-.05.77-.08,1.56-.15,3.1c-.08,2.06-.14,4.13-.16,6.2-.07,4.14,0,8.28.11,12.41a154.32,154.32,0,0,0,2.7,24.57c1.66,8,4.07,16,8.5,22.79a27.76,27.76,0,0,0,8.34,8.41,21.87,21.87,0,0,0,5.35,2.42c2,.52,3.94,1.1,6,1.53,16,3.7,32.62,4.75,49.12,5s33.08-.62,49.59-1.85,33-2.93,49.47-4.81,32.93-4,49.38-6.11c32.89-4.34,65.8-8.76,98.81-12.56s66.18-6.84,99.51-7.61q25-.34,49.84-.31l24.92.16c8.3.07,16.61.31,24.91.46,33.21.74,66.42,2,99.57,4.28l12.43.9c4.14.29,8.27.7,12.41,1,8.28.66,16.54,1.55,24.81,2.38,16.51,1.83,33,3.93,49.31,7.35l-.22,1c-8.11-1.54-16.36-2.58-24.58-3.59L750,207.53l-12.38-1.2c-8.26-.68-16.52-1.41-24.79-1.92-4.14-.27-8.27-.6-12.41-.81L688,202.93c-33.12-1.7-66.28-2.47-99.45-2.68-8.29,0-16.58-.13-24.87-.07l-24.87.11c-8.29,0-16.59.2-24.88.3s-16.59.14-24.85.32c-33.05.76-66.06,3.92-99,7.48s-65.85,8-98.83,11.94-66,7.79-99.19,9.87c-16.6,1-33.25,1.63-49.91,1.24s-33.39-1.69-49.69-5.66c-2-.48-4-1.07-6.08-1.65a24.48,24.48,0,0,1-5.93-2.77,30,30,0,0,1-9-9.23,52.08,52.08,0,0,1-5.39-11.49,86.49,86.49,0,0,1-3.12-12.19,156.82,156.82,0,0,1-2.33-24.91c-.08-4.16,0-8.33.12-12.49q.14-3.11.34-6.23l.23-3.11.13-1.55.07-.77,0-.39s0-.17,0-.1c2,.11.53.1,1,.18Z"/></svg>
                </div>
              </div>
            <?php } ?>
          <?php } else { ?>
          ...
          <div class="col-md-12 wizard">
            ...
            <div class="row wizard_main_screen hidden">
              <div class="col-sm-6 wizard_zones">
                ...
                <div class="zone zone_v0 draggable">V0</div>
                <div class="zone zone_v1 draggable">V1</div>
                <div class="zone zone_v2 draggable">V2</div>
                <div class="zone zone_v3 draggable">V3</div>
                <div class="zone zone_v4 draggable">V4</div>
                <div class="zone zone_v5 draggable">V5</div>
                <div class="zone zone_v- draggable">V-</div>

                <div class="zone zone_d2 draggable">D2</div>
                <div class="zone zone_d2_ draggable">D2</div>
                <div class="zone zone_d3 draggable">D3</div>
                <div class="zone zone_d4 draggable">D4</div>
                <div class="zone zone_d5 draggable">D5</div>
                <div class="zone zone_d6 draggable">D6</div>

                <div class="zone zone_s2 draggable">S2</div>
                <div class="zone zone_s2_ draggable">S2</div>
                <div class="zone zone_s3 draggable">S3</div>

              ...
              <?php } else if (current_user_can('contributor') || current_user_can('administrator') || (current_user_can('subscriber') && $new_registred == 1)) { ?>
                ...
                <div>
                  ...
                  <div class="for_desktop">
                    ...
                    <span class="arrow_title main_arrow_title">Начните работу в <b>"WizardDuos"</b> с загрузки фото.</span>
                  </div>
            ...
            <div class="row">
              <div class="col-md-12 steps">
                <div class="steps_item steps_item_1 wow bounceInUp" data-wow-duration="1.4s">
                  ...
                  <p class="description">Загрузите фото клиента и при необходимости выполните подрезку. Для этого в "WizardDuos" есть встроенные механизмы</p>
                </div>
